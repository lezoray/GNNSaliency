...
def train(model, train_loader, val_loader=None, epochs=100, lr=0.001, device='cpu', save_path='best_model.pt',restart=False):
...
model = MeshGNN(in_channels=4)
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')


print("\n=== Training + Saving ===\n")
train(model, train_loader, val_loader, epochs=1400, lr=0.001, device=device, save_path='best_model_FeastConv.pt',restart=False)
