...
from MeshGNN import MeshGNNGAT 
...
def train(model, train_loader, val_loader=None, epochs=100, lr=0.001, device='cpu', save_path='best_model_GAT.pt',restart=False):
...
print("\n=== Training + Saving ===\n")
train(model, train_loader, val_loader, epochs=1400, lr=0.001, device=device, save_path='best_model_GAT.pt',restart=False)
